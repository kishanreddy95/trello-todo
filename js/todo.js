  ...
  .then((arrayOfChecklists) => {
        ...
        $( "button" ).click(function() {
          ...
          .then((board) => {
            ...
            var request = new Request(`https://api.trello.com/1/cards/${cardId}/checklist/${checkItem.idChecklist}/checkItem/${checkItem.id}/state?key=${key}&token=${token}&value=true`, {
              method: 'PUT', 
            });
